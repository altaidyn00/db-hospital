...
def create_disease(
    ...
    try:
        db.execute(
            ...
            params={"disease_code": disease.disease_code, "description": disease.description, "pathogen": disease.pathogen, "id": disease.id},
        )
...
def update_disease(
    ...
    try:
        disease = db.execute(
            ...
            params={"disease_code": disease.disease_code, "description": disease.description, "pathogen": disease.pathogen, "id": disease.id, "disease_code": disease_code},
        ).fetchone()
